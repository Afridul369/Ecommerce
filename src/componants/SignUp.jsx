  ...
  return (
    ...
    <div className="py-32">
        <Container>
            ...
            <Text as='h1' text={"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem"} className='text-base text-footercolor font-dm mb-1'/>
            ...
            {/* ====================Personal Part=============== */}
            <Text as='h1' text={'Your Personal Details'} className='text-[39px] font-bold font-dm text-hoverheadeingC  mb-12'/>
            <div className="mb-16 border-b">
              ...
              <Flex className={'gap-x-43 mb-16'}>
                ...
                <div className="border-b">
                  <Text as='p' text='Telephone' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
            ...
            <div className="mb-16 border-b">
              <Flex className={'gap-x-12 mb-6'}>
                <div className="border-b">
                  <Text as='p' text='Address 1' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
                  <input type="text" placeholder='4279 Zboncak Port Suite 6212' className='text-sm text-headingC font-dm mb-3'/>
                </div>
                <div className="border-b">
                  <Text as='p' text='Address 2' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
              ...
              <Flex className={'gap-x-12 mb-6'}>
                <div className="border-b">
                  <Text as='p' text='City' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
            ...
            <div className="mb-16 border-b">
            <Flex className={'gap-x-40 mb-16'}>
                <div className="border-b">
                  <Text as='p' text='Password' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
                  <input type="password" placeholder='Password' className='text-sm text-headingC font-dm mb-4'/>
                </div>
                <div className="border-b">
                  <Text as='p' text='Repeat Password' className='text-base text-hoverheadeingC font-bold font-dm mb-3'/>
                  {/* <Text as='p' text='company@domain.com' className='text-sm text-headingC font-dm mb-4'/> */}
